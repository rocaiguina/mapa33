      ...
      map.addLayer(
        {
          ...
          paint: {
            'fill-color': [
              ...
              '#369ac1',
              'Co-manejo: DRNA y Taller de Arte y Cultura de Adjuntas',
              '#084e7a',
              'Co-manejo: DRNA y Club Cívico Ambiental de Palos Blancos',
              '#2e84c6',
              'US Fish and Wildlife Service (USFWS)',
              '#3cabef',
              'Programa de Parques Nacionales de PR',
              '#ff5e43',
              'Ciudadanos del Karso',
              '#b72200',
              'USDA Forest Service',
              '#f9ad9b',
              'Dueños, públicos y privados, siguiendo el Plan y Reglamento del APE del Carso',
              '#f48767',
              'Instituto de Cultura Puertorriqueña',
              '#e8512e',
              'Co-manejo: DRNA / NOAA',
              '#00c3ff',
              'Co-manejo: Programa del Estuario de la Bahía de San Juan y DRNA',
              '#02c6a1',
              'Para la Naturaleza',
              '#85e0d0',
              'Tropic Ventures Education and Research Foundation',
              '#3e9687',
              'Fundacion Luis Muñoz Marin',
              '#00c3ff',
              'Universidad de Puerto Rico',
              '#369ac1',
              'Co-manejo: Proyecto Agro Eco Turístico del Barrio Rio Hondo Inc y Municipio de Mayaguez',
              '#084e7a',
              /* other */ '#5AB6A2',
            ],
          },
