...
class MapToolBar extends React.Component {
  ...
  render() {
    const RadioMapView = (
      <Radio.Group
        onChange={this.props.onChangeModeView}
        value={this.props.mapView}
        size="large"
    ...
    const RadioAreaView = (
      <Radio.Group
        onChange={this.props.onChangeAreaView}
        value={this.props.areaView}
        className="popeditblack"
        size="large"
      >
        <Row>
    ...
    return (
      <div className="toolbar toolbar-menu">
        {this.state.mostrar ? (
          <div className={'overlaymenu'}>
            ...
            <div className={'menubottom'}>
              <div>
                <Button type="simplebtn2">
                  Visitar página <Icon type="arrow-right" />
                </Button>
        ...
        <ul>
          <li>
            <Button ghost onClick={this.openOverlay}>
              <Icon type="menu" />
            </Button>
          </li>
          <li>
